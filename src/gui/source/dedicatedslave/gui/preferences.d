...
import dedicatedslave.gui.common;
import dedicatedslave.gui.util.array;

//Preference Constants
enum SETTINGS_ID = "com.enthdev.DedicatedSlave.Settings";
enum SETTINGS_BASE_PATH = "/com/enthdev/DedicatedSlave";
...
enum SETTINGS_PROFILE_LIST_ID = "com.enthdev.DedicatedSlave.ProfilesList";
enum SETTINGS_PROFILE_ID = "com.enthdev.DedicatedSlave.Profile";
...
//Shortcuts
enum SETTINGS_KEY_BINDINGS_ID = "com.enthdev.DedicatedSlave.Keybindings";
...
package:
    ...
    void deleteProfile(string uuid) {
        string[] ps = gsProfileList.getStrv(SETTINGS_PROFILE_LIST_KEY);
        dedicatedslave.gui.util.array.remove(ps, uuid);
        gsProfileList.setStrv(SETTINGS_PROFILE_LIST_KEY, ps);
