...
private:
	...
	void onClickedInfo(ToolButton a){
		_loader.changeLogState("Starting Instance Windows: "~_parent.getSelectedInstanceName(), 0);
		GameInstance gi = _loader.getInstance(_parent.getSelectedInstanceName());
		w = new InstanceWindow(this, _loader, gi);
	}
...
public:
	...
	string getSelectedInstanceName(){
		return _parent.getSelectedInstanceName();
	}
